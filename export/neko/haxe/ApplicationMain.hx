...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("room-builder", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("room-builder", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "room-builder";
		app.meta["name"] = "room-builder";
